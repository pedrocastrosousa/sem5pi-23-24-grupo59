...
export class Edificio extends AggregateRoot<EdificioProps> {
  ...
  private constructor(props: EdificioProps, codigoEdificio: CodigoEdificio) {
    super(props, codigoEdificio);
  }

  public static create(props: EdificioProps): Result<Edificio> {
    const guardedProps = [
